...
def build_dataset(word_id_filename, train_samples_filename):
    dataset = {}
    with open(word_id_filename, 'rb') as handle:
        word_id = pickle.load(handle)
        dataset['word2id'] = word_id['word2id']
        dataset['id2word'] = word_id['id2word']
    with open(train_samples_filename, 'rb') as handle:
        train_samples = pickle.load(handle)
        dataset['trainingSamples'] = train_samples['train_samples']
